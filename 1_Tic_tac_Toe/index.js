(function() {
    ...
    function handleResultValidation(){
        ...
        // Check how to use array some() intead of for loop
        ...
        if(roundDraw){
            gameStatusEl.innerHTML = `Game ended in a Row!`;
            gameActive = false;
            return;
        }
        handlePlayerChange();
    ...
    function handlePlayerChange(){
        // If current player is X then set it to O else currentPlayer is O then set it to X
